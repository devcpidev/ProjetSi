...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 28 jan. 2020 à 16:16
...
(1, 'Direction Administration et Gestion des Produits');
...
(1, 'Service Prospection', 1),
(2, 'Service Reception', 1),
(3, 'Service Etude et Traitement', 1);
...
INSERT INTO `typeproduit` (`idTypeProduit`, `libelle`) VALUES
(1, 'Bien Bati'),
(2, 'Bien Non Bati');
...
(1, ' MBAYE', '773343173', 'Dakar', 'jamillaye@gmail.com', 'Jamil Laye', 'passer', 1, 4),
...
--
ALTER TABLE `cpidepartement`
  MODIFY `idDept` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `departement`
--
ALTER TABLE `departement`
  MODIFY `idDepartement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
