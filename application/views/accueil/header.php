...
<head>
    ...
    <!-- Bootstrap CSS
		============================================ -->
        <link rel="stylesheet" href="<?php echo base_url();?>public/css/modals.css">
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="<?php echo base_url();?>index.php/Login/home">
                     ...
                     if($this->session->user->libelle=="admin") 
                        ...
                        <li>
                            <a class="has-arrow" href="" aria-expanded="false"><i class="fa big-icon fa-user icon-wrap"></i> <span class="mini-click-non">Utilisateur</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                        ...
                        <li class="active">
                        <a class="" href="http://localhost/ProjetSi/index.php/organisation/liste">
                            <i class="fa big-icon fa-table icon-wrap"></i>
                            <span class="mini-click-non">Organisations</span>
                            </a>
                    
                        </li>

                        <li>
                        <a class="has-arrow" href="" aria-expanded="false"><i class="fa big-icon fa-table icon-wrap"></i> <span class="mini-click-non">Statistiques</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="" href="http://localhost/ProjetSi/index.php/Statistique/liste"><i class="fa fa-lightbulb-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Collectes</span></a></li>
                    ...
                    ?>
                     <?php
                     if($this->session->user->libelle=="reception_produit") 
                          {
                        echo '   
                        
                        
                        <li>
                            <a class="has-arrow" href="" aria-expanded="false"><i class="fa big-icon fa-envelope icon-wrap"></i> <span class="mini-click-non">Produits</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Inbox" href="http://localhost/ProjetSi/index.php/Reception/liste"><i class="fa fa-inbox sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste de tous les produits</span></a></li>
                    ...
                    <?php
                     if($this->session->user->libelle=="collecteur_zu") 
                          {
                        echo '   
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="" href="http://localhost/ProjetSi/index.php/Collecte/BienNonBati"><i class="fa fa-pencil sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Bien Non Bati</span></a></li>
                    ...
                    <?php
                     if($this->session->user->libelle=="collecteur_zpu") 
                          {
                        echo '   
